...
Usage:
    cd /path/to/ttc的交易系统
    PYTHONPATH=reloop/src python3 scripts/oneoff/batch_import_remaining.py [--limit N]
"""
...
from reloop.ingestion.pipeline import ingest_file


ROOT = Path(__file__).resolve().parents[2]
RESUME_DIR = ROOT / "简历数据"
DB_PATH = ROOT / "reloop" / "data" / "candidates.db"
