...
"""
    ...
    def test_quality_stats_structure(self):
        # quality_stats() reads ingestion_log, which is created lazily by the
        # ingestion pipeline; ensure it exists (idempotent).
        from ingestion.pipeline import init_ingestion_tables
