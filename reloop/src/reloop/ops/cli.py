...
Examples:
    ...
    python -m reloop.ops.cli ingest-file ../简历数据/张三.pdf --dry-run

    # Queue the record for RDS then Feishu delivery
    python -m reloop.ops.cli ingest-file ../简历数据/张三.pdf --write

    # Ingest raw text
    python -m reloop.ops.cli ingest-text --title "BOSS在线简历" --source-url "https://..."
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    file_parser.add_argument("--write", dest="dry_run", action="store_false", help="Queue for worker delivery")
