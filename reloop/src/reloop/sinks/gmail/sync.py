...
from reloop.config import DATA_DIR

DOWNLOAD_DIR = DATA_DIR / "gmail-attachments"
STATE_PATH = DATA_DIR / "gmail-state.json"
LOCK_PATH = DATA_DIR / "gmail-sync.lock"
DB_PATH = DATA_DIR / "candidates.db"
KEYCHAIN_ACCOUNT = "ttc-reloop"
            ...
            try:
                ...
                if size_result == "OK" and size_match and int(size_match.group(1)) > config.max_email_size_mb * 1024 * 1024:
                    ...
                    status["errors"].append(
                        f"跳过超过{config.max_email_size_mb}MB的邮件 UID "
