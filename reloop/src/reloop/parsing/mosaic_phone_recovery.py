...
from reloop.parsing.ocr import pdf_page_images
from reloop.utils.llm_client import complete_with_image, parse_json_safe
...
def _first_page_image(path: Path, parser_name: str) -> Path | None:
