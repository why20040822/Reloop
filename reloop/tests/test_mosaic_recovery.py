...
from reloop.parsing.mosaic_phone_recovery import RecoveryResult, recover_phone
from reloop.parsing.unified_parser import _build_confidences, _post_process_record
...
class TestMosaicPhoneRecovery(unittest.TestCase):
    ...
    @patch("reloop.parsing.mosaic_phone_recovery.complete_with_image")
